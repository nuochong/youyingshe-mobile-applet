<template>
  <div>
    ...
    <!-- 封面裁切组件 -->
    <clip-image :url="'https://resources.laihua.com/2019-1-26/6f5e4ad0-2133-11e9-97a0-49d3e303954e.png'" :ratio="[5,4]" @clipOver="clipOverHdl"
      @clipImageHide="clipHideHdl"></clip-image>
  </div>
</template>
<script>
